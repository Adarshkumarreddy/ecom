...
<div class="container">
  ...
  <div class="form-row">
    ...
    <div class="col-md-3 mb-3">
      ...
      <input type="int" class="form-control" id="discount" name="discount"  required>
      <div class="invalid-feedback">
        This Field Is required
      </div>
    </div>
  ...
  <div class="form-row">
    <div class="col-md-6 mb-3">
      ...
      <input type="int" class="form-control" id="quantity" name="quantity" required>
      <div class="invalid-feedback">
  ...
  <div class="col-md-5 mb-3">
    ...
    <textarea class="custom-select" id="shortdescription" name="shortdescription" rows="3"required></textarea>
  </div>
  <div class="col-md-12 mb-3">
    <label for="description">description</label>
    <textarea class="custom-select" id="description" name="description" rows="3"required></textarea>
  </div>
